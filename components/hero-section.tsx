    ...
    <section className="relative bg-gray-800 text-white">
      <div className="absolute inset-0">
        <Image
          ...
          alt="Roofer demonstrating craftsmanship on a roof at sunset, showcasing Summit Roofing's expertise in Alabama and Georgia."
          fill
          priority
          quality={75}
          sizes="100vw"
      ...
      <div className="relative container mx-auto px-4 md:px-6 py-24 md:py-32 lg:py-40 flex flex-col items-center text-center">
        ...
        <p className="mt-4 max-w-3xl text-lg md:text-xl text-gray-200 text-balance">
