      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-800">Don't Navigate Storm Damage Claims Alone</h2>
            <p className="mt-4 text-lg text-gray-600">
              Dealing with roof damage is stressful enough without the added complexity of an insurance claim. At Summit
              Roofing Professionals, we specialize in assisting homeowners in Alabama and Georgia with their roof
              insurance claims. We act as your advocate, ensuring the process is smooth, transparent, and that you
              receive the full compensation you're entitled to.
            </p>
          </div>
        </div>
      </section>
